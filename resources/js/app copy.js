...
// =========================
// GLOBAL LIVEWIRE TOAST
// =========================
document.addEventListener('livewire:init', () => {
    Livewire.on('tampil-toast', (event) => {
        ...
        const Toast = Swal.mixin({
            ...
            width: '400px', // <-- TAMBAHKAN INI (Bisa pakai '400px', '25rem', atau 'auto')
            customClass: {
                title: 'text-sm' // <-- (Opsional) Jika ingin mengatur ukuran font via Tailwind
            },
            didOpen: (toast) => {
