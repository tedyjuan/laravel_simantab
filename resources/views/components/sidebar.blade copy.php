<aside id="sidebar"
    ...
    <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
        ...
        <a href="{{ route('pegawai.index') }}"
            class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-colors group
                    {{ request()->routeIs('pegawai.index')
                        ...
                        : 'text-gray-600 hover:bg-gray-50 hover:text-indigo-600' }}">
            <span
                class="icon-[solar--users-group-rounded-outline] w-5 h-5 shrink-0 group-hover:text-indigo-600 text-gray-400 transition-colors"></span>
        ...
        <div>
            <button
                onclick="document.getElementById('submenu-master').classList.toggle('hidden'); this.querySelector('.chevron').classList.toggle('rotate-180')"
                ...
                <div class="flex items-center gap-3">
                    <span
                        class="icon-[solar--square-academic-cap-outline] w-5 h-5 shrink-0 group-hover:text-indigo-600 text-gray-400 transition-colors">
                    </span>
            ...
            <div id="submenu-master" class="hidden pl-4 pr-2 py-1 space-y-1 sidebar-text">
                <a href="{{ route('kelas.index') }}"
                    ...
                    <span
                        class="icon-[solar--square-academic-cap-outline] w-5 h-5 shrink-0 group-hover:text-indigo-600 text-gray-400 transition-colors"></span>
                    Master Kelas
                </a>
                <a href="{{ route('pegawai.index') }}"
                    class="group flex items-center gap-2 px-3 py-2 text-sm text-gray-500 rounded-lg hover:text-indigo-600 hover:bg-gray-50 transition-colors">
