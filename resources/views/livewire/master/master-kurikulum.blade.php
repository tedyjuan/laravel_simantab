<div id="halaman_master_kurikulum" x-data="{ modalOpen: false, deleteModalOpen: false, modalTitle: '', modalTitleDetail: '' }" x-on:open-modal.window="modalOpen = true"
    ...
    <div class="mb-5 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <button type="button"
            @click="
                modalOpen = true;
                modalTitle = 'Tambah Kurikulum';
                modalTitleDetail = 'Lengkapi data Kurikulum baru';
                            ...
                            <td class="pr-6">
                                <div class="flex items-center justify-end gap-1.5">
                                    ...
                                    <button type="button" wire:click="edit({{ $kurikulum->id }})" title="Edit"
                                        @click="
                                            modalTitle = 'Edit Kurikulum';
                                           modalTitleDetail = 'Perbarui data Kurikulum';
                                        "
